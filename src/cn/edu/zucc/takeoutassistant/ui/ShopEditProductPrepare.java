...
/**
 * Servlet implementation class ShopEditProductPrepare
 */
@WebServlet("/ShopEditProductPrepare")
public class ShopEditProductPrepare extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShopEditProductPrepare() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("editpreparing "+request.getParameter("product_id"));
		request.getRequestDispatcher("ShopEditProduct?product_id="+request.getParameter("product_id")).forward(request, response);
	}
