...
/**
 * Servlet implementation class ShopProductCategory
 */
@WebServlet("/ShopProductCategory")
public class ShopProductCategory extends HttpServlet {
...
//		System.out.println(cur_shop);
		try {
			...
			if (keyWord != null) {
				// 模糊查找
				productcategorys = pcm.fuzzySearch(keyWord, cur_shop.getShop_id());
			} else {
		...
		request.getRequestDispatcher("shop_productcategory.jsp").forward(request, response);
	}
