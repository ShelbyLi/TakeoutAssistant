					...
					<div class="brand">
						<div class="card">
							<div class="card-header card-header-primary">
								...
								<p class="card-category">User Register</p>
							...
							<div class="card-body">
								...
								<form action="UserRegister" method="post">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="password" class="form-control" name="user_pwd_check" required="required">
											</div>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="bmd-label-floating">电话号码</label>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="bmd-label-floating">邮箱</label>
									...
									<a href="user_login.jsp"><button type="button" class="btn btn-primary pull-right  btn-block">去登录</button></a>
