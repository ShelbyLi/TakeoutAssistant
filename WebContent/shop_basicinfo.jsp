		      ...
		      <div class="card">
		          ...
		          <div class="card-body">
		            <form>
		              <div class="row">
		                <div class="col-md-4">
		                  <div class="form-group">
		                    <label class="bmd-label-floating">隶属公司</label>
		              ...
		              <button type="submit" class="btn btn-primary pull-right">注销</button>
					  <button type="submit" class="btn btn-primary pull-left">上传修改</button>
