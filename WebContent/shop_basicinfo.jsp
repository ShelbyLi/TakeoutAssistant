...
<html>
<head>
<title>外卖小助手 - shop-basic info</title>
  <meta charset="utf-8" />
		  ...
		  <div class="row">
		    <!-- <div class="col-lg-6 col-md-12"> -->
		      <div class="card">
		          ...
		          <div class="card-body">
		            <form action="ShopEditBasicinfo" method="post">
		              <div class="row">
		                <div class="col-md-4">
		                ...
		                <div class="col-md-4">
		                  <div class="form-group">
		                    ...
		                    <input type="text" class="form-control" name="shop_level" value="${cur_shop.shop_level }" disabled >
		                  </div>
		                </div>
		              </div>
		              <div class="row" >
		    ...
		    <!-- <div class="col-lg-6 col-md-12"> -->
		      <div class="card">
		          <div class="card-header card-header-primary">
		            ...
		            <p class="card-category">你确定要离开外卖小助手吗? <i class="material-icons">🙁</i></p>
		          </div>
		          <div class="card-body">
