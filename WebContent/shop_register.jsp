									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="shop_name" required="required">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="password" class="form-control" name="shop_pwd" required="required">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="password" class="form-control" name="shop_pwd_check">
											</div>
										</div>
									</div>
									<button type="submit" class="btn btn-primary pull-right  btn-block">注册</button>
									<a href="shop_login.jsp"><button type="button" class="btn btn-primary pull-right  btn-block">去登录</button></a>
