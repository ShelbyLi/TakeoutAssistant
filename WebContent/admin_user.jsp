						  ...
						  <c:forEach items="${users }" var="item" varStatus="i">
			                  ...
			                  <tr>
			                    ...
			                    <td class="td-actions text-right">
			                       ...
			                       <a href="AdminEditUserPwd?user_id=${item.user_id }&user_old_pwd=${item.user_pwd }">
									<button type="button" rel="tooltip" title="重置该用户密码" class="btn btn-primary btn-link btn-sm">
										<i class="material-icons">edit</i>
									</button>
								  </a>
			                      <a href="AdminRemoveUser?user_id=${item.user_id }">
			                      	<button type="button" rel="tooltip" title="删除该用户" class="btn btn-danger btn-link btn-sm">
