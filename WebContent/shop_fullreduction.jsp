...
<html>
<head>
<title>外卖小助手 - shop-full reduction</title>
  <meta charset="utf-8" />
		    ...
		    <!-- <div class="col-lg-6 col-md-12"> -->
		      <div class="card">
		          <div class="card-header card-header-primary">
		            ...
		            <p class="card-category">增加你的新满减方案吧</p>
		          </div>
		          <div class="card-body">
		              <a href="shop_add_fullreduction.jsp">
		              	<button type="submit" class="btn btn-primary pull-left">添加满减方案</button>
		              </a>
		          </div>
		                ...
		                <tbody>
						  ...
						  <c:forEach items="${fullreductions }" var="item" varStatus="i">
			                  ...
			                  <tr>
								...
								<td>${item.fullreduction_amount }</td>
								<td>${item.fullreduction_discounted_price }</td>
								<%-- <td>${item.fullreduction_can_superimposed_with_coupons }</td> --%>
								<c:if test="${item.fullreduction_can_superimposed_with_coupons==0 }">
									<td>否</td>
								</c:if>
								<c:if test="${item.fullreduction_can_superimposed_with_coupons==1 }">
									<td>是</td>
								</c:if>
			                    <td class="td-actions text-right">
								  ...
								  <%-- </a> --%>
			                      <a href="ShopRemoveFullReduction?fullreduction_id=${item.fullreduction_id }">
