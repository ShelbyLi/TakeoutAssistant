...
<html>
<head>
<title>外卖小助手 - rider-to deliver</title>
  <meta charset="utf-8" />
        ...
        <div class="container-fluid">
		  ...
		  <div class="row">
                ...
                <div class="card-header card-header-primary">
                  <h4 class="card-title mt-0">已接的订单</h4>
                  <p class="card-category">尽快送达哦 </p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
			              <c:forEach items="${riderdeliverorders }" var="item" varStatus="i">
			                  <tr>
			                  	<td>${item.order_id }</td>
								<td>${item.shop_id }</td>
								...
								<td class="td-actions text-right">
			                      <a href="RiderDeliveryArrived?order_id=${item.order_id }">
			                      	<button type="button" rel="tooltip" title="已送达" class="btn btn-primary btn-link btn-sm">
