						    ...
						    <div class="col-md-12">
						      <div class="form-group">
						        ...
						        <table class="table">
			                		...
			                		<tr>
			                			<td>
			                				<input type="radio" name="fullreduction_can_superimposed_with_coupons" value="1"/>是
			                			</td>
			                			<td>
			                				<input type="radio" name="fullreduction_can_superimposed_with_coupons" value="0" checked="checked"/>否
			                			</td>
				                  	</tr>
